...
public abstract class AutomataModelChecker<State, Action> implements ModelChecker<State, Action> {
  ...
  protected AutomataModelChecker(@NonNull LTS<State, Action> lts, @NonNull State pointedState) {
